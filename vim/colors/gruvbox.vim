...
let s:gb.dark0       = ['#121212', 0]       " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 234]     " 50-48-47
let s:gb.dark1       = ['#3c3836', 234]     " 60-56-54
let s:gb.dark2       = ['#504945', 235]     " 80-73-69
let s:gb.dark3       = ['#665c54', 236]     " 102-92-84
...
call s:HL('GruvboxBg2', s:fg2, s:bg0)
...
if version >= 700
  ...
  call s:HL('TabLineFill', s:fg1, s:bg3, s:invert_tabline)
  " Active tab page label
  call s:HL('TabLineSel',   s:yellow, s:bg1, s:invert_tabline . s:bold)
  call s:HL('TabLineLast',  s:fg1,    s:bg3, s:underline)
...
call s:HL('SpecialKey', s:yellow, s:bg1)
...
call s:HL('StatusLine',   s:bg3, s:fg1, s:inverse)
...
if version >= 700
  ...
  " Popup menu: selected item Setting
...
" Alternative setting
call s:HL('DiffChange', s:aqua, s:bg1)
call s:HL('DiffText',   s:yellow, s:bg0, s:bold)
...
if has("spell")
  ...
  " Not recognized word
  call s:HL('SpellBad',   s:fg1, s:red, s:undercurl, s:blue)
  " Wrong spelling for selected region
  call s:HL('SpellLocal', s:fg1, s:red, s:undercurl, s:aqua)
  " Rare word
  call s:HL('SpellRare',  s:fg1, s:red, s:undercurl, s:purple)
endif
