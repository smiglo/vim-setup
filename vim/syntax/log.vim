...
syn match logTime        /\s*\<\d\d:\d\d:\d\d\(\.\d\{6,\}\)\?\>/                                                                               nextgroup=logId,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logValue,logModuleC
...
syn match logId          /\s*\<\x\{6\}-[A-Z][A-Z0-9]\+-\d\+\>\s*/                                                              conceal cchar=∙ nextgroup=logModuleC,logException,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logTime,logValue,logTmp
syn match logId          /\s*\%(\[\d\+\]:\?\|\[\d\+\]\s\?\s*\|\[tid=\d\+\]\)\s*/                                               conceal cchar=∙ nextgroup=logException,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logTime,logValue,logTmp
syn match logId          /\s*\%(\<\d\{6}-\d\d:\d\d:\d\d\.\d\{6\}\s\?\>\|\[\?[0-9\-]\+T[0-9:.]\+Z\]\?\)\s*/                     conceal cchar=∙ nextgroup=logException,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logTime,logValue,logTmp
syn match logId          /\s*\[mod=[A-Z][^\]]*\]\s*/                                                                           conceal cchar=∙ nextgroup=logException,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logTime,logValue,logTmp
syn match logModuleC     /\<[A-Za-z][0-9a-zA-Z.\\_-]\+\%((\d\+)\):\s/                                                                          nextgroup=logException,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logTime,logValue,logTmp contains=logId,logTmp
