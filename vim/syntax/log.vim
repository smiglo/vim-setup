...
syn match logTime        /\s*\<\d\d:\d\d\(:\d\d\(\.\d\+\)\?\)\?\>/                                                                              nextgroup=logId,logMy,logIssue,logDebug,logNotice,logInfo,logWarning,logError,logFatal,logValueStr,logValue,logModuleC contains=logTimeNS
